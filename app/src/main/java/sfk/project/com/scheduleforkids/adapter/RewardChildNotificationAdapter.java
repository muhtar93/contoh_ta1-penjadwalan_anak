...
import sfk.project.com.scheduleforkids.DetailRewardChildActivity;
...
public class RewardChildNotificationAdapter extends RecyclerView.Adapter<RewardChildNotificationAdapter.MyViewHolder> {
    private List<Notification> notificationList;
    private Context context;

    public RewardChildNotificationAdapter(List<Notification> notificationList, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row_reward_notification, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        /*holder.setClickListener(new ItemClickListener() {
            @Override
            public void onClick(View view) {
                Intent detailCatalog = new Intent(context, DetailRewardChildActivity.class);
