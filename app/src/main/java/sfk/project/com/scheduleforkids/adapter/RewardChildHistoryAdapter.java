...
public class RewardChildHistoryAdapter extends RecyclerView.Adapter<RewardChildHistoryAdapter.MyViewHolder> {
    private List<Notification> notificationList;
    private Context context;

    public RewardChildHistoryAdapter(List<Notification> notificationList, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row_reward_history_child, parent, false);
