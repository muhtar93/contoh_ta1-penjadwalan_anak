...
public class MenuNotificationScheduleAdapter extends RecyclerView.Adapter<MenuNotificationScheduleAdapter.MyViewHolder>{

    private List<Schedule> notificationList;
    private Context context;

    public MenuNotificationScheduleAdapter(List<Schedule> notificationList, Context context) {
