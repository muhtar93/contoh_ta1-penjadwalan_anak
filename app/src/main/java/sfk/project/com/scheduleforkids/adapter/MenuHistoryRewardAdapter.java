...
public class MenuHistoryRewardAdapter extends RecyclerView.Adapter<MenuHistoryRewardAdapter.MyViewHolder>{

    private List<Reward> notificationList;
    private Context context;

    public MenuHistoryRewardAdapter(List<Reward> notificationList, Context context) {
