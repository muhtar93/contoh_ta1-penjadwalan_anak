...
import sfk.project.com.scheduleforkids.DetailScheduleChildActivity;
...
public class MenuScheduleOrtuAdapter extends RecyclerView.Adapter<MenuScheduleOrtuAdapter.MyViewHolder>{

    private List<Schedule> notificationList;
    private Context context;

    public MenuScheduleOrtuAdapter(List<Schedule> notificationList, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row_menu_schedule_ortu, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.setClickListener(new ItemClickListener() {
            @Override
            public void onClick(View view) {
                Intent detailCatalog = new Intent(context, DetailScheduleChildActivity.class);
