...
public class RewardChildAdapter extends RecyclerView.Adapter<RewardChildAdapter.MyViewHolder> {
    private List<Notification> notificationList;
    private Context context;

    public RewardChildAdapter(List<Notification> notificationList, Context context) {
