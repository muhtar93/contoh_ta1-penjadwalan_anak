...
import sfk.project.com.scheduleforkids.DetailDataChildParentActivity;
import sfk.project.com.scheduleforkids.EditDataChildParentActivity;
...
public class MenuChildOrtuAdapter extends RecyclerView.Adapter<MenuChildOrtuAdapter.MyViewHolder>{

    private List<Child> notificationList;
    private Context context;

    public MenuChildOrtuAdapter(List<Child> notificationList, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row_menu_child_ortu, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Child notification = notificationList.get(position);
        ...
        holder.setClickListener(new ItemClickListener() {
            @Override
            public void onClick(View view) {
                Intent detailCatalog = new Intent(context, DetailDataChildParentActivity.class);
