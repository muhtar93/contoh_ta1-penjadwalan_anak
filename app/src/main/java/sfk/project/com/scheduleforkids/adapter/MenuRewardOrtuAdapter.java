...
import sfk.project.com.scheduleforkids.EditRewardParentActivity;
...
public class MenuRewardOrtuAdapter extends RecyclerView.Adapter<MenuRewardOrtuAdapter.MyViewHolder>{

    private List<Reward> notificationList;
    private Context context;

    public MenuRewardOrtuAdapter(List<Reward> notificationList, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row_menu_reward_ortu, parent, false);
